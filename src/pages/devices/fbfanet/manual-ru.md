...
- LK8000: реализация прямого чтения и отправки в разработке.
...
Параметры RSSI и SNR последнего принятого радио-пакета данных можно прочитать, но нельзя подписаться на изменения.
