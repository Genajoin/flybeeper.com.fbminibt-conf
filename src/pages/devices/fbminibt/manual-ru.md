...
![Расположение кнопок — верхняя меняет громкость вверх, нижняя — вниз, круг — питание, квадрат — отмена](/manual-media/fbminibt/finger-en.jpg)
...
![Конфигуратор — звуковая кривая и пороги в браузерном интерфейсе](/manual-media/fbminibt/settings.jpg)
